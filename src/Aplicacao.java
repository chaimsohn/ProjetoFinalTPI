...
public class Aplicacao {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int anoBrasileirao = getAno();


        // obter a implementação: (ponto extra - abstrair para interface)
        CampeonatoBrasileiroImpl resultados =
                new CampeonatoBrasileiroImpl(file, (jogo) -> jogo.data().data().getYear() == anoBrasileirao);
    ...
    private static int getAno() {
        System.out.print("Digite o Ano que deseja obter as informações do Brasileirão: \t");
        int getAnoBrasileirao = new Scanner(System.in).nextInt();
        return getAnoBrasileirao;
    }
